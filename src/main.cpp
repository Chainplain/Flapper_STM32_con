...
{
	uint8_t Dev_t[15] = {'K','Y','K','J','2','3','-','2','8','Z','_','0','1','_','1'}; //硬件号：KYKJ23-26Z_00/01/02_1---KYKJ23-26Z_00/01/02_5，01内部晶振，02外部晶振，合计共5块板子;对应项目编号：HWKC26Z-P01。
	return Dev_t[i];           //在原始版本00上01/02修改第5/6路输出24V为12V；同时01内部晶振，02外部晶振，03联调3路输出/28V/44V/功率开关
}

uint8_t Device_Statusf_get(int j)
{
	uint8_t Fusion[16] = {'K','Y','K','J','2','3','-','2','8','Z','_','0','1','_','0','1'};	//固件版本号：KYKJ23-26Z_00/01/02/03_1	01内部晶振，02/03外部晶振，第一版默认输出			 			
	return Fusion[j];		      //在原始版本00上01/02修改第5/6路输出24V为12V；同时01内部晶振，02外部晶振，03外部晶振28V外部触发控制
}